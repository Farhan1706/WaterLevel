...
<html>
<head>
	<title>Peringatan Ketinggian Air</title>
		...
		<div class="row parent">
			<div class="col-md-3 col-12 col-sm-12 col-lg-3 child">
				<div class="fixed-top text-center mt-5">
					<h1 style="color: #FFF;font-family: Comic Sans MS;">Peringatan Ketinggian Air</h1>
				</div>
			</div>
			<div class="col-md-6 col-lg-6 col-12 col-sm-12 child">
				<div class="form">
					<form action="" method="POST">
						<input type="email" name="email" class="input shadow" placeholder="Masukan e-mail Anda." autocomplete="off">
					</form>
				</div>
			</div>
			<div class="col-md-3 col-12 col-sm-12 col-lg-3 child">
